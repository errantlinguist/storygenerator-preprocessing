...
"""
Reads in literature chapters stored in HTML format and prints them each to their own text file.
"""
...
def __create_argparser() -> argparse.ArgumentParser:
	result = argparse.ArgumentParser(
		description="Reads in literature chapters stored in HTML format and prints them each to their own text file.")
